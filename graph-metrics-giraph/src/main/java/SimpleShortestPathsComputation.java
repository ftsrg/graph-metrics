...
public class SimpleShortestPathsComputation
	...
	// This is how we will be passing an ID of a starting vertex: via command
	// line argument given
	...
	public void compute(Vertex<LongWritable, DoubleWritable, FloatWritable> vertex, Iterable<DoubleWritable> messages)
		...
		if (LOG.isDebugEnabled()) { // this is how real-world Giraph
									// applications handle debug output
			LOG.debug(
