...
public class DimensionalClustering1 {
	...
	public static class DimensionalClustering1Computation
			extends BasicComputation<LongWritable, Text, Text, MapFriendsList> {
		...
		public void compute(Vertex<LongWritable, Text, Text> vertex, Iterable<MapFriendsList> messages)
			...
			double dc1 = 0.0;
			if (oneTriads != 0) {
				dc1 = (double) twoTriangles / oneTriads;
			}
	...
	public static class MasterCompute extends DefaultMasterCompute {
		...
		public final void compute() {
			...
			if (superstep == 0) {
				...
				setComputation(DimensionalClustering1Computation.class);
			}
		}
	}
